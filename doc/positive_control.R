...
set.seed(1)
##################################################
####### Three Patients opposite direction ########
##################################################
...
png("../res/pos_control_2sample_oppo_true_prop.png", height = 2000, width = 2000, res = 300)
...
png("../res/pos_control_2sample_oppo_assigned_prop.png", height = 2000, width = 2000, res = 300)
...
png("../res/pos_control_2sample_true_prop.png", height = 2000, width = 2000, res = 300)
ggplot(time_prop, aes(x = Group, y = Proportion, fill = as.factor(time))) +
    geom_bar(stat = "identity", position = "dodge") +
    labs(x = "Group", y = "Proportion", fill = "time", 
         title = "Cell Type True Proportion") +
...
png("../res/pos_control_2sample_assigned_prop.png", height = 2000, width = 2000, res = 300)
ggplot(res_prop, aes(x = assigned_cluster, y = Proportion, fill = as.factor(time))) +
    geom_bar(stat = "identity", position = "dodge") +
    labs(x = "assigned_cluster", y = "Proportion", fill = "time", 
         title = "Cell Type Assigned Proportion") +
...
png("../res/pos_control_1sample_true_prop.png", height = 2000, width = 2000, res = 300)
ggplot(time_prop, aes(x = Group, y = Proportion, fill = as.factor(time))) +
    geom_bar(stat = "identity", position = "dodge") +
    labs(x = "Group", y = "Proportion", fill = "time", 
         title = "Cell Type True Proportion") +
...
png("../res/pos_control_1sample_assigned_prop.png", height = 2000, width = 2000, res = 300)
ggplot(res_prop, aes(x = assigned_cluster, y = Proportion, fill = as.factor(time))) +
    geom_bar(stat = "identity", position = "dodge") +
    labs(x = "assigned_cluster", y = "Proportion", fill = "time", 
         title = "Cell Type Assigned Proportion") +
