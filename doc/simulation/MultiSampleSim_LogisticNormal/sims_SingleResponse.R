...
dir <- "/work/users/e/u/euphyw/scLDAseq/data/simulation/MultiSample_LogisticNormal/NormalGamma_SingleResponse/"
...
sd <- replicate(simplex, diag(0, 1), simplify = FALSE)
type = "NullModel"
