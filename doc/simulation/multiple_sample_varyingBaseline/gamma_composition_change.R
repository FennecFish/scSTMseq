...
files <- list.files(path = "/work/users/e/u/euphyw/scLDAseq/data/simulation/MultiSample_VaryingBaseline_noBatch_StromalCell/sims/")
...
for(file_name in files){
  ...
  scSTM_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/MultiSample_VaryingBaseline_noBatch_StromalCell/scSTM_noContent_Prevalence_TimeandResponse/scSTM_",
                       set_level,".rds")
