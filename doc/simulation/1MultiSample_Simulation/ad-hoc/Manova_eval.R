...
##### analysis ####'
dir <- "/work/users/e/u/euphyw/scLDAseq/data/simulation/1MultiSample/SingleResponse/nSample20_nCellType10_noBatch_StromalCell/ManovaTheta_Pooled_noContent_Prevalence_Time/"
...
name <- basename(dir)
saveRDS(res, file = paste0("res/1MultiSample_SingleResponse_Simulation/ManovaRM_",name,".rds"))
