...
##### analysis ####'
dir <- "/work/users/e/u/euphyw/scLDAseq/data/simulation/1MultiSample/SingleResponse/nSample20_nCellType5_noBatch_StromalCell/ManovaTheta_Manualsims_Pooled_noContent_Prevalence_Time/"
...
dat <- readRDS("res/1MultiSample_SingleResponse_Simulation/1000ManovaTheta_Pooled_noContent_Prevalence_Time.rds")
