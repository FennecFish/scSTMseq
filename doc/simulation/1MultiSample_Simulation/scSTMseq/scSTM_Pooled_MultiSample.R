...
# scSTM.mod <- selectModel(sce = sims,sample = NULL, gamma.prior = "Pooled",
...
saveRDS(scSTM.mod, file = paste0(dir, "scSTM_Pooled_Sample_noContent_Prevalence_TimeandResponse/", 
