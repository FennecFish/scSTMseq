...
scSTM.mod <- selectModel(sce = sims,
                         ...
                         max.em.its = 100, net.max.em.its = 10)
# scSTM.mod <- selectModel(sce = sims,
#                          K = ngroup, prevalence = NULL, content = ~Batch,
...
saveRDS(scSTM.mod, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark/scSTM_Content_noPrevalance/", 
