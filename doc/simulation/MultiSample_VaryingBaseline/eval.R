...
for(file_name in files){
  ...
  ##### scSTM_Pooled
  scSTM_pooled_name <- paste0(dir, "scSTM_Pooled_Content_Prevalence_TimeandResponse/scSTM_",set_level,".rds")
  ...
  ##### scSTM_L1
  scSTM_L1_name <- paste0(dir, "scSTM_L1_Content_Prevalence_TimeandResponse/scSTM_",set_level,".rds")
  if(file.exists(scSTM_L1_name)){
    scSTM_L1 <- readRDS(scSTM_L1_name)
    scSTM_L1_cluster <- process_scSTM(scSTM_L1)
    dat$scSTM_L1_cluster <- scSTM_L1_cluster[match(rownames(dat), names(scSTM_L1_cluster))]
  } else {dat$scSTM_L1_cluster <- NA}
  
  ##### scSTM_LinearRegression
  scSTM_LR_name <- paste0(dir, "scSTM_LinearRegression_Content_Prevalence_TimeandResponse/scSTM_",set_level,".rds")
...
write.csv(res, file = paste0("res/adjRandIndex_", sim_setup, ".csv"))
