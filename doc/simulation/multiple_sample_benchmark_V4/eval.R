...
for(file_name in files){
  ...
  # scSTM_Content_Batch_Prevalence
 scSTM_C_Batch_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/scSTM_Content_Batch_Prevalence_Time/scSTM_",set_level,".rds")
 if(file.exists(scSTM_C_Batch_P_name)){
   scSTM_C_Batch_P <- readRDS(scSTM_C_Batch_P_name)
   scSTM_C_Batch_P_cluster <- process_scSTM(scSTM_C_Batch_P)
   dat$scSTM_C_Batch_P_cluster <- scSTM_C_Batch_P_cluster[match(rownames(dat), names(scSTM_C_Batch_P_cluster))]
 } else {dat$scSTM_C_Batch_P_cluster <- NA}

   # scSTM_Content_Batch_noPrevalence
#  scSTM_C_Batch_noP_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/scSTM_Content_Batch_noPrevalence/scSTM_",set_level,".rds")
#  if(file.exists(scSTM_C_Batch_noP_name)){
#    scSTM_C_Batch_noP <- readRDS(scSTM_C_Batch_noP_name)
#    scSTM_C_Batch_noP_cluster <- process_scSTM(scSTM_C_Batch_noP)
#    dat$scSTM_C_Batch_noP_cluster <- scSTM_C_Batch_noP_cluster[match(rownames(dat), names(scSTM_C_Batch_noP_cluster))]
#  } else {dat$scSTM_C_Batch_noP_cluster <- NA}

  # # scSTM_C_nP
  # scSTM_C_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/scSTM_Content_noPrevalance/scSTM_",set_level,".rds")
  ...
  # scSTM_C_P
  # scSTM_C_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/scSTM_Content_Prevalance/scSTM_",set_level,".rds")
  # if(file.exists(scSTM_C_P_name)){
  ...
  # fastTopics
  # fasttopic_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/fastTopics/fastTopics_", set_level, ".rds")
  ...
  # Seurat
  # seurat_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/seurat/seurat_", set_level, ".rds")
 ...
 # } else{dat$seurat_cluster <- NA}
  ...
  # # sctransform
  # sctf_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/sctransform/sctransform_", set_level, ".rds")
  ...
  # 
  # # monocle3
  monocle_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V4/monocle3/monocle3_", set_level, ".rds")
  ...
  # adjusted_rand_indices <- adjustedRandIndex(dat[, "monocle3_cluster"], sims$Group)
...
pre_res <- read.csv("res/adjRandIndex_multiple_sample_benchmark_V4.csv")
res <- read.csv("res/adjRandIndex_multiple_sample_benchmark_V4_update.csv") %>%
...
pre_res_updated <- pre_res %>%
  dplyr::mutate(across(starts_with("scSTM_C_Batch_P_cluster"),
                       ~ ifelse(nSample == "nsample6", 
                                res$scSTM_C_Batch_P_cluster[match(sim, res$sim)], 
                                .))) %>%
  dplyr::mutate(across(starts_with("monocle3_cluster"),
                       ~ ifelse(nSample == "nsample6", 
                                res$monocle3_cluster[match(sim, res$sim)], 
                                .)))


write.csv(pre_res_updated, file = "res/adjRandIndex_multiple_sample_benchmark_V4.csv")
