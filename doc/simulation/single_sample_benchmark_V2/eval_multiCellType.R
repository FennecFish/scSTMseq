...
error_file <- c("sims_multiCellType_1722494199_L4_c3_nsample1.rds", "sims_multiCellType_1722494199_L4_c3_nsample1.rds")
files <- files[!files %in% error_file] # read connection error
res <- data.frame()
...
for(file_name in files){
  ...
  file_path <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/sims/sims_", set_level, ".rds")
  ...
  # scSTM_nC_P
  scSTM_nC_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/scSTM_noContent_Prevalance/scSTM_",set_level,".rds")
  ...
  # scSTM_C_nP
  scSTM_C_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/scSTM_Content_noPrevalance/scSTM_",set_level,".rds")
  ...
  # scSTM_C_P
  scSTM_C_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/scSTM_Content_Prevalance/scSTM_",set_level,".rds")
  if(file.exists(scSTM_C_P_name)){
  ...
  # Seurat
  seurat_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/seurat/seurat_", set_level, ".rds")
  ...
  # sctransform
  sctf_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/sctransform/sctransform_", set_level, ".rds")
  ...
  # fastTopics
  fasttopic_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/fastTopics/fastTopics_", set_level, ".rds")
  ...
  # monocle3
  monocle_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/monocle3/monocle3_", set_level, ".rds")
  ...
  res.temp <- data.frame(
    sim = setup,
    seed = unlist(strsplit(setup, "_"))[1],
    control = unlist(strsplit(setup, "_"))[2],
    level = unlist(strsplit(setup, "_"))[3],
    nCellType = unlist(strsplit(setup, "_"))[4],
    nSample = unlist(strsplit(setup, "_"))[5],
...
write.csv(res, file = "res/adjRandIndex_single_sample_multiCellType_benchmark_V2.csv")
