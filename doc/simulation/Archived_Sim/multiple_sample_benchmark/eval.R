...
files <- list.files(path = "/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark/sims/", pattern = "sims*")
...
for(file_name in files){
  ...
  sims <- readRDS(paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark/sims/sims_", set_level, ".rds"))
  dat <- colData(sims) %>% data.frame() 
  
  # scSTM_nC_P
  scSTM_nC_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark/scSTM_noContent_Prevalance/scSTM_",set_level,".rds")
  ...
  # scSTM_C_nP
  scSTM_C_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark/scSTM_Content_noPrevalance/scSTM_",set_level,".rds")
  ...
  # scSTM_C_P
  scSTM_C_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark/scSTM_Content_Prevalance/scSTM_",set_level,".rds")
  if(file.exists(scSTM_C_P_name)){
...
write.csv(res, file = "res/adjRandIndex_multiple_sample_benchmark.csv")
