...
t1 <- proc.time()
scSTM.mod <- selectModel_parallel(sce = sims,
...
# saveRDS(scSTM.mod, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark_V2/scSTM_Content_noPrevalance/", 
