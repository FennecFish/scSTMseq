...
#SBATCH --job-name=supp_V3_n12_batch
#SBATCH --output=supp_V3_n12_batch_%A_%a.out
#SBATCH --error=supp_V3_n12_batch_%A_%a.err
#SBATCH --ntasks=1
...
SCSTM_DIR="/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V3/scSTM_Content_BatchNoInteraction_Prevalence_Time"
