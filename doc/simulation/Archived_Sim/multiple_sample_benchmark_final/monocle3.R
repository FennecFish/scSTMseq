...
cds <- align_cds(cds, num_dim = 100, alignment_group = "Batch_ID")
...
saveRDS(cds, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/MultiSample_VaryingBaseline_noBatch_CancerCell/monocle3/", 
