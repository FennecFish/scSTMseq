...
files <- list.files(path = "/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_final/sims/", pattern = "sims*")
# files <- list.files(
#   path = "/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_final/sims/", 
...
for(file_name in files){
  ...
  file_path <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_final/sims/sims_", set_level, ".rds")
 ...
 scSTM_C_Batch_P_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_final/scSTM_Content_Batch_Prevalence_Time/scSTM_",set_level,".rds")
...
#  } else {dat$scSTM_C_Batch_noP_cluster <- NA}
  ...
  # fastTopics
  fasttopic_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_final/fastTopics/fastTopics_", set_level, ".rds")
  ...
  # Seurat
 seurat_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_final/seurat/seurat_", set_level, ".rds")
 ...
 rm(sub_sims)
  ...
  # 
  # monocle3
  monocle_name <- paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_final/monocle3/monocle3_", set_level, ".rds")
  ...
  # adjusted_rand_indices <- adjustedRandIndex(dat[, "scSTM_C_Batch_P_cluster"], sims$Group)
...
write.csv(res, file = "res/adjRandIndex_multiple_sample_benchmark_final.csv")
