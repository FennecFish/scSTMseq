...
saveRDS(res, file = "res/composition_change/NormalGamma_SingleResponse_MixedLinear_nSample3_nCellType5_noBatch_StromalCell_Theta.rds")

# # # ############################# analysis #########################################
# # # # # res <- readRDS("res/composition_change/NormalGamma_ZeroPsi_nSample3_nCellType5_noBatch_StromalCell.rds")
# res <- readRDS("res/composition_change/NormalGamma_SingleResponse_MixedLinear_nSample3_nCellType5_noBatch_StromalCell_Theta.rds")
# 
# res <- res[grep("HighVar", names(res))]
...
#   geom_boxplot() +
#   labs(title = "Difference Between Simulated Proportion Versus Estimated Proportion Using Linear Mixed Regression In Alt Model", x = "Group", y = "Proportion Difference") +
#   theme_minimal() +
#   facet_grid(~Sample)
