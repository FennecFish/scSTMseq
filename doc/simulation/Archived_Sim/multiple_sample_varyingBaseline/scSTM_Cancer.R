...
sims <- readRDS(paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/MultiSample_VaryingBaseline_Batch_CancerCell/sims/", file_name))
...
saveRDS(scSTM.mod, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/MultiSample_VaryingBaseline_Batch_CancerCell/scSTM_noContent_Sample_Prevalence_TimeandResponse/", 
