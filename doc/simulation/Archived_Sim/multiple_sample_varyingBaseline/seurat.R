...
seurat.sims <- FindVariableFeatures(seurat.sims, selection.method = "vst", nfeatures = 800)
...
saveRDS(seurat.sims, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/MultiSample_VaryingBaseline_Batch0.5_CancerCell/seurat/", 
