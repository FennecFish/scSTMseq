...
scSTM.mod <- selectModel(sce = sims,
                         ...
                         max.em.its = 100, net.max.em.its = 20) #, sample = "Batch",)
...
saveRDS(scSTM.mod, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/single_sample_benchmark/scSTM_f_nc/", 
