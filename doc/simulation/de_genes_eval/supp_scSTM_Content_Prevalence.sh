...
#SBATCH --job-name=supp_DE_C_P
#SBATCH --output=supp_DE_C_P_%A_%a.out
#SBATCH --error=supp_DE_C_P_%A_%a.err
#SBATCH --ntasks=2
...
SIMS_DIR="/work/users/e/u/euphyw/scLDAseq/data/simulation/de_gene_eval/sims"
SCSTM_DIR="/work/users/e/u/euphyw/scLDAseq/data/simulation/de_gene_eval/scSTM_Content_Prevalance"
