...
#                          K = ngroup, prevalence = ~Batch, content = NULL,
...
saveRDS(scSTM.mod, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/multi_sample_benchmark_V2/scSTM_noContent_Prevalance/", 
