...
# file.test <- file.exists(paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/V5/scSTM/scSTM_", set_level, ".rds"))
# if(file.test) {stop(paste0("scSTM_", set_level, ".rds already exists"))}
...
saveRDS(res, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/V5/scSTM/",
