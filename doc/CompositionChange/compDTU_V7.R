...
# files <- list.files(path = "/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/V7/scSTM/")
# 
# all.Y <- vector(mode = "list")
# for (file_name in files){
#   scSTMobj <- readRDS(paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/V7/scSTM/", file_name))
...
#   all.Y[[set_level]] <- res
# }
# saveRDS(all.Y, file = "allY_V7_scSTM.rds")
...
# files <- list.files(path = "/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/V7/sims/")
# all.Y <- vector(mode = "list")
# for (file_name in files){
...
#   cat(file_name, "\n")
# }
# saveRDS(all.Y, file = "allY_V7_sims.rds")

# # all.Y <- readRDS("allY_V5_c3_sims.rds")
# compDTU <- function(Y){
#   Group <- Y$time
#   Group <- factor(Group)
#   Y <- Y[,3:ncol(Y)]
