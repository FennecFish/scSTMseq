...
# file_name <- "sims_1716521897_pos_L1_c9.rds"

set_level <- sub("sims_([^.]*)\\.rds", "\\1",  file_name)

sims <- readRDS(paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/pos_V1/sims/", file_name))
# quick qc
...
# save test dataset
saveRDS(Xtest, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/pos_V1/test/",
                             "test_", set_level, ".rds"))
...
saveRDS(res, file = paste0("/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/pos_V1/scSTM/",
