...
#SBATCH --job-name=scSTM_V6_c9
#SBATCH --output=scSTM_V6_c9_%A_%a.out
#SBATCH --error=scSTM_V6_c9_%A_%a.err
#SBATCH --ntasks=1
...
DIR="/work/users/e/u/euphyw/scLDAseq/data/simulation/composition_change/V6/sims"
...
Rscript V6_scSTM.R "${FILES[$INDEX]}"
