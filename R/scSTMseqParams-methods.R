...
#' @importFrom splatter getParams setParamUnchecked bringItemsForward paramsExpander showPP
#' @importFrom checkmate checkInt checkIntegerish checkNumber checkNumeric checkLogical checkFlag checkCharacter
## New class and method overrides for scSTMseq
#' @export
setGeneric("setParam", function(object, name, value) standardGeneric("setParam"))

#' @export
setGeneric("setParams", function(object, ...) standardGeneric("setParams"))
...
#' @rdname newParams
#' @export
newSTMParams <- function(...) {
  params <- new("STMParams")
...
setValidity("STMParams", function(object) {
...
#' @rdname setParam
setMethod("setParam", "STMParams", function(object, name, value) {
...
#' @rdname setParams
setMethod("setParams", "STMParams", function(object, update = NULL, ...) {
    checkmate::assertClass(object, classes = "STMParams")
...
setMethod("show", "STMParams", function(object) {
    pp <- list(
        "Batches:" = c(
            "[Batches]" = "nBatches",
...
#' @rdname expandParams
setMethod("expandParams", "STMParams", function(object) {
    n <- getParam(object, "nBatches")
